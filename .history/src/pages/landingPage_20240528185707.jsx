...
const LandingPage = () => {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-100">
      <div className="absolute top-0 left-0 w-1/2 h-full parallax parallax-left" style={{ backgroundImage: `url(${leftImage})` }}></div>
      <div className="absolute top-0 right-0 w-1/2 h-full parallax parallax-right" style={{ backgroundImage: `url(${rightImage})` }}></div>
