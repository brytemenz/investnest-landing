    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-2/5 relative">
        <div className="bg-cover bg-center h-full" style={{ backgroundImage: `url(${rightImage})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col justify-center items-center text-white px-8">
            ...
            <button className="bg-yellow-600 text-white px-4 py-2 rounded-md font-bold">Join Waitlist</button>
          </div>
        </div>
      </div>
    </div>
