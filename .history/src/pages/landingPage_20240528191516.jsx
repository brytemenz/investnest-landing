    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-2/5 relative flex flex-col justify-between">
        <div className="bg-cover bg-center h-full" style={{ backgroundImage: `url(${rightImage})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-80 flex flex-col justify-start text-white px-8">
            <div className="mt-8">
              <h2 className="text-3xl font-bold mb-4">Welcome to the forefront of real estate investing innovation!</h2>
            ...
            <button className="bg-yellow-600 text-white px-4 py-2 rounded-md font-bold self-end mt-auto mr-8">Join Waitlist</button>
          </div>
        </div>
      </div>
    </div>
