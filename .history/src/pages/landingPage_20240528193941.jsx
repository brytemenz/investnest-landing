...
import { FaFacebook, FaLinkedin, FaInstagram, FaTwitter } from 'react-icons/fa'; // Import Font Awesome icons
        ...
        <div className="bg-cover bg-center h-full" style={{ backgroundImage: `url(${rightImage})` }}>
          <div className="absolute inset-0 bg-black bg-opacity-90 flex flex-col justify-start items-start text-white px-8"> {/* Increased opacity to make it darker */}
            ...
            <div className="text-sm mt-8 flex items-center">
              <FaFacebook className="text-white mr-4 cursor-pointer" />
              <FaLinkedin className="text-white mr-4 cursor-pointer" />
              <FaInstagram className="text-white mr-4 cursor-pointer" />
              <FaTwitter className="text-white mr-4 cursor-pointer" />
            </div>
