          ...
          <div className="w-full lg:w-2/5 relative flex flex-col justify-end">
            <div className="bg-cover bg-center h-full" style={{ backgroundImage: `url(${rightImage})` }}>
              <div className="absolute inset-0 bg-black bg-opacity-90 flex flex-col justify-start items-start text-white px-8">
                <div className="mt-24 text-center"> {/* Adjusted here */}
                  <Button className="bg-yellow-500 text-black px-4 prounded-md font-bold hover:text-yellow-500" style={{ border: 'none', margin: 'auto' }}>Join the Waitlist</Button> {/* Adjusted margin */}
                </div>
                ...
                <Button className="bg-yellow-500 text-black px-4 prounded-md font-bold ml-2 items-center justify-center mx-auto hover:text-yellow-500" style={{ border: 'none' }}>Join the Waitlist</Button>
