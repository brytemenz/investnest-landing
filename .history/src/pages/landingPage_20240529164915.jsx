...
const LandingPage = () => {
  ...
  const handleEmailSubmit = () => {
    ...
    const userMessage = "Hello, this is my Email"; // Get user's message content from the UI input
  
    const templateParams = {
      user_email: email,
      from_name: 'new investor', // Replace with actual sender name if available
      message: userMessage // Use the user's message content
    };
