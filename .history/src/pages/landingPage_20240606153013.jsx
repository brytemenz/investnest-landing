...
import rightImage from '../assets/rightmage.jpg';
    ...
    <div className="landing-page min-h-screen flex flex-col lg:flex-row">
      {isLoading ? (
        ...
        <>
          ...
          <div className="w-full lg:w-2/5 relative flex flex-col justify-end bg-cover bg-center h-full" style={{ backgroundImage: `url(${rightImage})` }}>
              ...
              <div className="mt-32 text-left lg:text-center w-full">
                ...
                <div className="mt-20 flex justify-center w-full">
                  <Input 
                    ...
                    className="border-b-2 border-white bg-zinc-800 text-white placeholder-white::placeholder px-4 py-2 focus:outline-none focus:text-black border-yellow-500 w-full lg:w-auto" 
                    value={email}
