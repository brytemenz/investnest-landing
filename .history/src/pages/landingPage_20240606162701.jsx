...
import LoadingSpinner from '../components/loadingSpinner'; // Ensure component name is properly capitalized
import ThreeDImage from '../components/ThreeDImage';
import Footer from '../components/footer'; // Ensure component name is properly capitalized
  ...
  return (
    <div className="landing-page min-h-screen flex flex-col lg:flex-row">
      {isLoading ? (
        ...
        <>
          <div className="w-full lg:w-full relative flex flex-col justify-center items-center bg-gray-900">
            {show3DModel ? (
              <ThreeDImage modelUrl="/room.glb" mode={viewMode} />
            ) : (
              <div className="h-full relative w-full bg-cover bg-center" style={{ backgroundImage: `url('/path/to/your/left-image.jpg')` }}>
          ...
          <div className="w-full lg:w-full relative flex flex-col justify-end bg-cover bg-center" style={{ backgroundImage: `url(${rightImage})` }}>
